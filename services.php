 ...
 <header class="bg-dark py-5" id="main-header">
     <div class="container h-100 d-flex align-items-end justify-content-center w-100">
         <div class="text-center text-white w-100">
             ...
             <p class="lead fw-normal text-white-50 mb-0">Cuidamos de tus dispositivos electrónicos</p>
             <div class="col-auto mt-2">
                 <button class="btn btn-warning btn-lg rounded-0" id="send_request" type="button">Enviar una Solicitud de Servicio</button>
             </div>
         </div>
     </div>
 </header>
 ...
 <section class="py-5">
     <div class="container px-4 px-lg-5 mt-5">
         <div class="row">
             <div class="col-md-12">
                 <h3 class="text-center">Nuestros Servicios Disponibles</h3>
                 <hr class="bg-primary opacity-100">
                 <div class="form-group">
                     <div class="input-group mb-3">
                         <input type="search" id="search" class="form-control" placeholder="Búsqueda de Servicios" aria-label="Search Service Here" aria-describedby="basic-addon2">
 ...
 <script>
     $(function() {
         ...
         $('#service_list .view_service').click(function() {
             uni_modal("Información de Servicio", "view_service.php?id=" + $(this).attr('data-id'), 'mid-large')
         })
         $('#send_request').click(function() {
             if ("<?= $_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 2 ?>" == 1)
                 uni_modal("Completa el formulario de solicitud de servicio", "send_request.php", 'mid-large');
             else
                 alert_toast(" Loguéate Primero");
         })
