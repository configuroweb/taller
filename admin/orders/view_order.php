...
<div class="card card-outline card-dark shadow rounded0-0">
    <div class="card-header">
        <h3 class="card-title"><b>Detalles de la Orden</b></h3>
        <div class="card-tools">
            ...
            <a class="btn btn-default btn-flat border btn-sm" href="./?page=orders"><i class="fa fa-angle-left"></i> Volver</a>
        </div>
    </div>
    <div class="card-body">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="" class="text-muted">Fecha Orden</label>
...
<script>
    $(function() {
        ...
        $('#delete_order').click(function() {
            _conf("¿Estás seguro de eliminar este pedido de forma permanente?", "delete_order", [])
        })
    })
