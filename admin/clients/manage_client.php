...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Actualizar " : "Crear " ?> Cliente</h3>
	</div>
	<div class="card-body">
		<form action="" id="client-form">
			...
			<div class="form-group">
				...
				<input name="middlename" id="middlename" type="text" class="form-control rounded-0" value="<?php echo isset($middlename) ? $middlename : ''; ?>" placeholder="opcional">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<small><em class="text-muted">Rellenar solo para actualizar la Contraseña del Cliente</em></small>
			</div>
			<div class="form-group">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="client-form">Guardar</button>
		<a class="btn btn-flat btn-default" href="?page=clients">Cancelar</a>
	</div>
</div>
<script>
